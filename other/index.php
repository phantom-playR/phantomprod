...
if (isset($_GET['mapname']))
    $map = '<br>Sur la map: '.$_GET['mapname'];

if (isset($_GET['steamid'])) {
    $data = 'http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?key=E0349E582F45444A23E5EA973D4E5081&steamids='.$_GET['steamid'];
...
<body> 
    ...
    <div class="container">
        <div class="jumbotron" style="margin-top: 50px;">
            ...
            <p class="lead">
                Bienvenue sur le serveur H2O !<br>
                <small>
                    <ul style="line-height: 1.6;">
                        <li>Pouet.</li>
                        <li>Nocli est AFK ?</li>
                        <li>Interdit de.</li>
                        <li>We play in Français</li>
                        <li>Même les admins se font bannir ici...</li>
                    </ul>
                </small>
            </p>
    ...
    <div style="position: absolute;bottom: 0px;left: 20px;font-size: 12px;min-width: 260px;" class="well well-sm">
        ...
        Salut, <b><?php echo $plname ?></b><?php echo $map ?><br>
        Musique: "<?php echo $authors[$r];?>"
    </div>
